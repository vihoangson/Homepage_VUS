tinymce.PluginManager.add("template", function(e) {
	...
	function a(t) {
		function a(t) {
			...
			}) : (l = c.content, a(l)), n.find("#description")[0].text(t.control.value()
				.description)
		}
		var n, l, i = [];
	...
	function c(t, a) {
		...
		a = r(a, "template_replace_values"), o = p.create("div", null, a), s = p.select(".mceTmpl", o), s && s.length > 0 && (o = p.create("div", null), o.appendChild(s[0].cloneNode(!0))), i(p.select("*", o), function(t) {
			c(t, e.getParam("template_cdate_classes", "cdate")
				.replace(/\s+/g, "|")) && (t.innerHTML = n(e.getParam("template_cdate_format", e.getLang("template.cdate_format")))), c(t, e.getParam("template_mdate_classes", "mdate")
				.replace(/\s+/g, "|")) && (t.innerHTML = n(e.getParam("template_mdate_format", e.getLang("template.mdate_format")))), c(t, e.getParam("template_selected_content_classes", "selcontent")
				.replace(/\s+/g, "|")) && (t.innerHTML = m)
	...
	e.addCommand("mceInsertTemplate", c), e.addButton("template", {
		...
		i(a.select("div", t.node), function(t) {
			a.hasClass(t, "mceTmpl") && (i(a.select("*", t), function(t) {
				a.hasClass(t, e.getParam("template_mdate_classes", "mdate")
					.replace(/\s+/g, "|")) && (t.innerHTML = n(e.getParam("template_mdate_format", e.getLang("template.mdate_format"))))
			}), l(t))
		})
	})
});